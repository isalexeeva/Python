...
import random
# team1 = [7.86, 6.76, 9.97, 9.08, 5.45, 6.9, 8.65, 5.17, 8.17, 5.06, 7.56, 7.1, 7.18, 8.25, 5.53, 7.95, 8.91, 7.11, 8.29, 9.52]
# team2 = [7.13, 5.7, 8.89, 5.36, 5.62, 9.46, 5.82, 8.67, 8.41, 7.0, 5.31, 7.8, 9.93, 7.76, 7.4, 8.26, 7.94, 5.71, 7.89, 7.77]
team1 = [round(random.uniform(2, 5), 2) for _ in range(20)]
team2 = [round(random.uniform(2, 5), 2) for _ in range(20)]
print(team1)
print(team2)
